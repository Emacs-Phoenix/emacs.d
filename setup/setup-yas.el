(setq yas-dir (expand-file-name "snippets" user-emacs-directory))
(require 'yasnippet)
(yas-global-mode 1)
...
(define-key js2-mode-map [tab] 'tab-indent-or-complete)
;;(define-key css-mode-map (kbd "TAB") 'tab-indent-or-complete)
